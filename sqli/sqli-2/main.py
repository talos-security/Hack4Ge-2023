...
if __name__ == "__main__":
    ...
    if not os.path.exists(app.database):
        with sqlite3.connect(app.database) as connection:
            ...
            c.execute('INSERT INTO employees VALUES("hack4ge", "{}")'.format("flag\{hack4ge_sqli2\}"))
            
            connection.commit()
            connection.close()

    app.run(host='0.0.0.0',port = 5001) # runs on machine ip address to make it visible on netowrk
